select *,row_number() over (partition by category_L1 order by RevPerImpression desc) DesiredPositioning,'MissLEgypt' Halo_Country
from(
...
group by 1) a
inner join
`noted-computing-279322.halo_1_1_Egypt.refProducts` b
