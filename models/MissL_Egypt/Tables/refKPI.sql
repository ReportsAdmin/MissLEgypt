select *,'MissLEgypt' Halo_Country from
(
                ...
                'Integer' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Total Sales Value (With VAT in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                ...
                'Integer' KPI_FORMAT,
                'fKPIsCalc' KPI_SQL,
                'Average Order Value (in EGP)' KPI_DESCRIPTION,
                ...
                'Integer' KPI_FORMAT,
                'fKPIsCalc' KPI_SQL,
                'Total Sales Value (Without VAT in EGP)' KPI_DESCRIPTION,
                ...
                7010 KPI_ID,
                3 LAYER,
                'valu_per' KPI_VARIABLE,
                'Percentage' KPI_FORMAT,
                'fKPIsCalc' KPI_SQL,
                'Valu (%)' KPI_DESCRIPTION,
                'valu,orders_auth' KPI_DEPENDENTS,
                'safe_divide(valu,orders_auth)' KPI_CALC,
                'safe_divide(valu_prevX,orders_auth_prevX)' KPI_CALC_PREVX,
                'safe_divide(valu_PrevyearsameX,orders_auth_PrevyearsameX)' KPI_CALC_PREVYEARSAMEX
                ...
                'Integer' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Influencers Sales Value (in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
                ...
                'Integer' KPI_FORMAT,
                'fKPIsCalc' KPI_SQL,
                'Average Daily Sales (in EGP)' KPI_DESCRIPTION,
                ...
                'Integer' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Overall Sales Value (with VAT in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
                ...
                'Integer' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Unsuccessful Sales Value (with VAT in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
                ...
                'Decimal' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Total Spend (in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
                ...
                'Integer' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Target Sales Value (in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
                ...
                'Integer' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Target Spend (in EGP)' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
                ...
                'Decimal' KPI_FORMAT,
                'fKPIs' KPI_SQL,
                'Target Spend (in EGP) - Facebook & Instagram' KPI_DESCRIPTION,
                '' KPI_DEPENDENTS,
                '' KPI_CALC,
                '' KPI_CALC_PREVX,
                '' KPI_CALC_PREVYEARSAMEX
