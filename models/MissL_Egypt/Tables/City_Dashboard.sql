...
(select ord.*, fulfil.time_to_fulfill, deliv.Delivered_quantity, deliv.Delivered_Orders, 'MissLEgypt' Halo_Country from
(
...
(select
 ...
 from `noted-computing-279322.halo_1_1_Egypt.magento_transactionnew` trans
 left join  `noted-computing-279322.halo_1_1_Egypt.fOrders` ord
