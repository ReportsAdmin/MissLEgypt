...
(
    ...
    from `noted-computing-279322.halo_1_1_Egypt.Calendar` a,(select distinct product_id,product_sku,launch_date from `noted-computing-279322.halo_1_1_Egypt.refProducts`) b
