...
from(
(
select  ad_name keyword,adset_name ad_content, campaign_name from `noted-computing-279322.halo_1_1_Egypt.fFBBaseTable`
...
from `noted-computing-279322.halo_1_1_Egypt.fGABaseCosts`) b
