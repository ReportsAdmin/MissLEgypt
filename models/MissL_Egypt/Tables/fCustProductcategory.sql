select *,row_number() over (partition by user_id order by orders desc,revenue desc) Productcategory_rank,'MissLEgypt' Halo_Country
from(
...
from
`noted-computing-279322.halo_1_1_Egypt.fOrders` ord,
`noted-computing-279322.halo_1_1_Egypt.refProducts` cat
