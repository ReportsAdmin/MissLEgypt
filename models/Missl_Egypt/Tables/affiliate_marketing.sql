...
from `noted-computing-279322.halo_1_1_Egypt.Calendar`
cross join
`noted-computing-279322.halo_1_1_Egypt.magento_affiliate_marketing`) a
left join
(
...
from `noted-computing-279322.halo_1_1_Egypt.magento_affiliate_marketing` x
left join `noted-computing-279322.halo_1_1_Egypt.fOrders` y
