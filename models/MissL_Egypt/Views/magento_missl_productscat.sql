...
from `noted-computing-279322.halo_1_1_Egypt.magento_productcategoryproduct` a
left join `noted-computing-279322.halo_1_1_Egypt.magento_productcategoryentityvarchar` b
on a.category_id=b.entity_id
left join `noted-computing-279322.halo_1_1_Egypt.magento_productentityvarchar` c
on a.product_id=c.entity_id and c.store_id  = b.store_id
left join `noted-computing-279322.halo_1_1_Egypt.magento_productcategoryentity` d
