...
(select source_medium,date date_start,Halo_Country
 from `noted-computing-279322.halo_1_1_Egypt.Calendar` a,(select distinct source_medium from `noted-computing-279322.halo_1_1_Egypt.refKeywords` ) b
 ) cal
...
from `noted-computing-279322.halo_1_1_Egypt.fUAInsights` a, `noted-computing-279322.halo_1_1_Egypt.refKeywords` b
...
from `noted-computing-279322.halo_1_1_Egypt.fAdInsights` a, `noted-computing-279322.halo_1_1_Egypt.refKeywords` b
where a.ad_cat_id=b.ad_cat_id
)
group by 1,2,3) b
...
from(
select a.*,b.source_medium
from `noted-computing-279322.halo_1_1_Egypt.fOrders` a, `noted-computing-279322.halo_1_1_Egypt.refKeywords` b
where a.ad_cat_id=b.ad_cat_id
)
